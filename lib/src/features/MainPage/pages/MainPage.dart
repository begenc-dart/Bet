                  ...
                  child: Padding(
                    ...
                    child: GridView.builder(
                      ...
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        crossAxisCount: 3,
                                  childAspectRatio: 0.3,mainAxisSpacing: 10,crossAxisSpacing: 10      ),
                      itemBuilder: (context, index) {
                        return Container(
                          width: MediaQuery.of(context).size.width*0.8,
                          height: 40,
                          ...
                          child: Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  Assets.images.match.image(package: "gen",width: 40,height: 40),
                                  AppText.s14w500LbL("Croatia HLM",color: ColorName.text,)
                                ],
                              ),
                              Row(
                                children: [
                                  CircleAvatar(
                                    ...
                                    child: AppText.s12w500LbM("1",color: ColorName.text,),
                                  ),
                                  5.boxW,
                                  Icon(Icons.star_border,color: ColorName.dustyBlue,)
                                ],
                              )
                            ],
                          ),
